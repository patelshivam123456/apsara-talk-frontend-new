...
import AstroProfileForm from "@/components/AstroProfile/AstroProfileForm";

export default function AstroProfilePage({ theme = "public" }) {
      ...
      >
        ...
        <div className="mt-2 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid grid-cols-2 gap-2 text-center sm:grid-cols-4">
            {["Birth", "Place", "Signs", "Paya"].map((item) => (
              <div
                key={item}
